...
class Solution
{
    ...
    {
        del_node.data = del_node.next.data;		// Place data of next node in del node
        del_node.next = del_node.next.next;		// Place next of next node in next part of del, the connection will be cut
    }
}

public class del_node_LL {
